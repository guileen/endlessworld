...
void guiFrame(bool show_demo_window);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for(int i = 0; i < 10; i++) {
            ...
            float angle = 20.0f * i + currentFrame * 10;
...
// enable or disable dragMode
void mouse_button_callback(GLFWwindow* window, int button, int action, int mods)
{
    isDragMode = (button == GLFW_MOUSE_BUTTON_RIGHT && action == GLFW_PRESS);
    if(isDragMode) {
